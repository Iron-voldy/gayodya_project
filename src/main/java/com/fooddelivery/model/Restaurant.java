...
public class Restaurant implements Serializable {
    ...
    public Restaurant(String name, String cuisineType, String address) {
        this("R001", "Pizza Heaven", "Italian", "4.5", "30-45 min", "/images/restaurants/pizza-heaven.jpg");
        this.name = name;
        this.cuisineType = cuisineType;
        this.address = address;
    }
...
//    public String toFileString() {
//        return String.join(",",
//                id, name, cuisineType, address, phone, email,
//                openingHours, String.valueOf(rating), deliveryTime,
