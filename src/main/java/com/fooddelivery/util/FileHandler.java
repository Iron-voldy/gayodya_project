...
public class FileHandler {
    ...
    public static String getFilePath(String fileName) {
        ...
        public static void initializeDefaultAvatar() {
            String avatarPath = getResourcePath("images/avatars/default.png");
            ...
            if (!avatarFile.exists()) {
                try {
                    ...
                    InputStream input = FileHandler.class.getResourceAsStream("/default-avatar.png");
                    if (input != null) {
...
//    }
//
//    public static void writeToFile(String filePath, String join) {
//
//    }
}
